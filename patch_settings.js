...
// We need to add the QR code to the Profile Information section
const profileFormReplacement = `
...
code = code.replace(/<div className="flex flex-col sm:flex-row gap-8 items-start mb-8">[\s\S]*?<div className="pt-2">/, profileFormReplacement + '\n                <div className="pt-2">');
