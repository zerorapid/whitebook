...
sidebar = sidebar.replace(/<div className="w-8 h-8 rounded-lg bg-blue-500 flex items-center justify-center font-bold">C<\/div>\s*<span className="font-semibold tracking-wide">CRM_OS<\/span>/, svgLogo);
fs.writeFileSync('src/components/Sidebar.tsx', sidebar);

// Update title in layout
let layout = fs.readFileSync('src/app/layout.tsx', 'utf8');
layout = layout.replace(/title: "CRM OS"/g, 'title: "White Book"');
layout = layout.replace(/description: "Next Generation Directory"/g, 'description: "White Book - Private Directory"');
