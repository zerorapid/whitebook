        ...
        <div className="px-8 pb-8">
          <div className="relative flex justify-between items-end -mt-12 mb-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {contact.phone && (
                <>
                  <a href={`tel:${contact.phone.replace(/[^0-9+]/g, '')}`} className="w-9 h-9 sm:w-10 sm:h-10 bg-green-100 text-green-700 rounded-full flex items-center justify-center hover:bg-green-200 transition-colors shadow-sm" title="Call">
                    <Phone className="w-4 h-4" />
                  </a>
                  <a href={`https://wa.me/${contact.phone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 bg-[#25D366]/20 text-[#25D366] rounded-full flex items-center justify-center hover:bg-[#25D366]/30 transition-colors shadow-sm" title="WhatsApp">
              ...
              <button 
                ...
                className="px-4 py-2 sm:px-5 bg-primary text-primary-foreground text-sm font-semibold rounded-full shadow-sm hover:bg-primary/90 transition-all flex items-center gap-2"
              >
